...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/pong-game-raylib
OBJDIR = obj/x64/Debug/pong-game-raylib
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/pong-game-raylib
OBJDIR = obj/x86/Debug/pong-game-raylib
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/pong-game-raylib
OBJDIR = obj/ARM64/Debug/pong-game-raylib
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGET = $(TARGETDIR)/pong-game-raylib
OBJDIR = obj/x64/Release/pong-game-raylib
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/pong-game-raylib
OBJDIR = obj/x86/Release/pong-game-raylib
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/pong-game-raylib
OBJDIR = obj/ARM64/Release/pong-game-raylib
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
clean:
	@echo Cleaning pong-game-raylib
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
